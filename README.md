...
1- Arithmetic Operations: This includes basic operations such as addition, subtraction, multiplication, and division.<br />
2- Logic Operations: This includes operations such as AND, OR, NOT, XOR, and bit shifts.<br />
